...
#define MONETA_DESCRIBE_ENTITY_WITH_NAMESPACE(ns_seq, entity, members) \
...
#define MONETA_DEFINE_AND_DESCRIBE_ENTITY_STRUCT_WITH_NAMESPACE(ns_seq, entity, members) \
