...
namespace moneta { namespace traits {
	...
	namespace detail {
		...
		template <class T>
		struct get_original_args : boost::mpl::identity<
			typename T::original_args
		> {};
			...
			boost::mpl::push_back<
				...
				boost::mpl::if_<
					...
					moneta::traits::detail::vectorize_entity_groups<
						get_original_args<boost::mpl::_2>
					>
				>
			>
		> {};
	...
	struct entity_group {
		...
		typedef typename detail::vectorize_entity_groups<
			original_args
		>::type vectorized;

		typedef typename mplx::flatten<
			vectorized
		>::type flattened;
