...
BOOST_AUTO_TEST_CASE(test_codec_io_copy_randomaccessiterator) {
...
BOOST_AUTO_TEST_CASE(test_codec_io_copy_randomaccessiterator2) {
...
BOOST_AUTO_TEST_CASE(test_codec_io_copy_inputiterator) {
	const int ints[] = { 1, 2, 3, 4, 5 };
	int out[128];
	std::fill(std::begin(out), std::end(out), 0);
...
BOOST_AUTO_TEST_CASE(test_codec_io_copy_inputiterator2) {
	const char src[] = "abcdefghijklmnopqrstuvwxyz";
